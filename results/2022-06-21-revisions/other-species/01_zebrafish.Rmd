...
gene2intron <- read_tsv(file.path(project_dir, "dbases", "white/eisa/tx2gene.tsv"))
```
...
stage_cols <- stage_col_palette[1 + !levels(tpm_means$stage) %in% c("1-cell",
                                                                    "2-cell",
                                                                    "128-cell",
                                                                    "1k-cell")]
...
save_plot(file.path(pfig_dir$fig_1, "1c_zebrafish-pre-mRNA-ratios.pdf"),
           p,
          base_width = 6,
          base_height = 4.5)
