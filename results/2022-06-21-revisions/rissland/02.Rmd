...
to_comp_upset <- list(
  `DeRenzis, et al.` = d_genes$all_zyg$gene_id,
  `Kwasnieski, et al.` = b_genes$gene_id,
  `Lott, et al.` =  union(edata_genes$zyg$gene_id, 
                                edata_genes$matzyg$gene_id),
...
intersection_summary <- mutate(intersection_summary, 
       discovered_class = case_when(
         ...
         !`Intron method` & `De Renzis et al` & !`Kwasnieski et al` & !`Lott et al` ~ "DeRenzis, et al.",
...
intersection_summary <- mutate(intersection_summary, 
                               discovered_class = factor(discovered_class,
                                                         levels = c("This paper", "DeRenzis, et al.", "Kwasnieski, et al.", "Lott, et al.")))
...
```{r, fig.height=7, fig.width=3.5, eval = FALSE}
