...
h2 <- Heatmap(rs_exon_intron_comps_log$intron, name = "Intron log TPM",
              na_col = "black",
        show_row_dend = F, 
        show_column_dend = F,
        cluster_columns = FALSE,
...
p <- ggplot(mean_tpms_annot, aes(stage_ael, TPM)) +
...
pdf(file.path(pfig_dir$fig_3, "3b_fcount_method_classification_overlap_upset.pdf"),
    width = 4.5, 
    height = 3)
p
dev.off()
...
pdf(file.path(pfig_dir$sup_fig_5, "intron_method_classification_overlap_upset.pdf"),
    width = 4.5, 
    height = 3)
p
dev.off()
