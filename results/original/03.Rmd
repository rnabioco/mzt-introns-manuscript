...
write_csv(peps_out, append = TRUE,
          file.path(out_dir, "Casas-Vila_et_al_2017_mass_spec_data.csv"))
```
...
```{r}
bw_fns <- dir(here("data/bigwigs/drosophila/bt2/rpf/EICHHORN"), 
              pattern = "fwd.bw", 
              full.names = TRUE)
```
...
fwd_bws <- here("data/bigwigs/drosophila/bt2/rpf/EICHHORN",
                 str_c(rpf_mdata$run_accession, "_fwd.bw"))

names(fwd_bws) <- rpf_mdata$sample_title

rev_bws <-  here("data/bigwigs/drosophila/bt2/rpf/EICHHORN",
