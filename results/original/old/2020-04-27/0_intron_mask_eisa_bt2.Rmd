...
saveRDS(ivl_df, "ivl_df_bt2.rds")
ivl_df <- readRDS("ivl_df_bt2.rds")
...
```{r}
gtf_fn <- "annotation_files/eisa/eisaR.gtf"
...
write_tsv(db_out, "annotation_files/eisa/fly_intron_mask_txcoords_eisa_bt2_align.bed", col_names = F)
...
```{r}
dup_tx <- read_tsv("annotation_files/eisa/duplicated_seqs.tsv")

chroms <- read_tsv("annotation_files/eisa/eisa.fa.fai",
...
write_lines(chroms$chrom, file.path("annotation_files", "eisa",
