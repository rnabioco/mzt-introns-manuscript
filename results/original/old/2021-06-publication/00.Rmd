...
ref_dir <- here("dbases-rerun", "drosophila", "saf")
...
bws <- dir(
  file.path(here("data-rerun"), "bigwigs", "drosophila", "star", "RISSLAND"),
  full.names = TRUE,
  pattern = ".bw"
)
