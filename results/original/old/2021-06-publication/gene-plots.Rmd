...
gtf_01 <- import('/Users/kriemo/Projects/mzt-introns/data/ont-genome-ensembl/bed/0-1_hr_rerun.gtf')

gtf_45 <- import('/Users/kriemo/Projects/mzt-introns/data/ont-genome-ensembl/bed/4-5_hr_rerun.gtf')
...
walk(to_plot,
    ~{
      features <- switch_isos %>%
        ...
        pull(transcript_id) 
      pdf(file.path(nano_tx_outdir, str_c(.x, "_coverage.pdf")), height = 4, width = 12)
...
pdf("Test.pdf", height = 5);plot_tx_nano_aln_coverage(bam_fns[c(1,3)], features, gtf_obj, read_heights = c(3, 5)); dev.off()
```
